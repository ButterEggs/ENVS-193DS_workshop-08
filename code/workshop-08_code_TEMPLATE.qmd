...
par(mfrow = c(2,2)) #creates 2x2 grid to show diagnostic plots
plot(model1)
plot(model2)
plot(model3)
plot(model4)
...
(In average, plant masses in drought stressed conditions were 0.12 $\pm$ 0.02 g less than plant masses in well watered conditions across species)
